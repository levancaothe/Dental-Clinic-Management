...
<html lang="vi">
    <head>
        <meta charset="UTF-8">
        <title>SmileCare - Bảng điều khiển bệnh nhân</title>
        ...
        <div class="page-container">
            ...
            <div class="dashboard-wrapper content-area">
                <div class="dashboard-header">
                    <h2>Chào mừng đến với Smile care</h2>
                </div>
                ...
                <div class="dashboard-options">
                    ...
                    <a href="<c:url value='/PatientCreateBookingServlet'/>" class="dashboard-option">
                        <i class="fas fa-calendar-check"></i>
                        <h5>Đặt lịch</h5>
                    </a>

                    <a href="<c:url value='/PatientAppointmentListServlet'/>" class="dashboard-option">
